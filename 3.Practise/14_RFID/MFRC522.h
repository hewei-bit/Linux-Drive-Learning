...
static struct gpio RFID_gpios[] = {
	{ PAD_GPIO_C+30, GPIOF_OUT_INIT_HIGH, "RST" }, /* default to OFF */
	{ PAD_GPIO_D+0, GPIOF_DIR_IN, "MISO" }, /* default to OFF */
	{ PAD_GPIO_C+31, GPIOF_OUT_INIT_HIGH, "MOSI" }, /* default to OFF */
	{ PAD_GPIO_C+7, GPIOF_OUT_INIT_HIGH, "SCK" }, /* default to OFF */
	{ PAD_GPIO_C+8, GPIOF_OUT_INIT_HIGH, "SDA" }, 
};

//定义MFRC522的CS引脚操作，x=1时CS=1，x=0时CS=0
#define MFRC522_CS(x) x ? gpio_set_value(PAD_GPIO_C+8,1):gpio_set_value(PAD_GPIO_C+8,0)
#define MFRC522_Rst(x) x ? gpio_set_value(PAD_GPIO_C+30,1):gpio_set_value(PAD_GPIO_C+30,0)
/////////////////////////////////////////////////////////////////////
//MF522命令字
/////////////////////////////////////////////////////////////////////
