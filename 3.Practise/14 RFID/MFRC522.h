...
//RC522引脚
#define rc522_RST	PAD_GPIO_C+30
#define rc522_MOSI  PAD_GPIO_C+31
#define rc522_SCK   PAD_GPIO_C+7
#define rc522_SDA   PAD_GPIO_C+8 
#define rc522_MISO  PAD_GPIO_D+0 

//定义MFRC522的CS引脚操作，x=1时CS=1，x=0时CS=0
#define MFRC522_CS(x) gpio_set_value(rc522_SDA,(x))
#define MFRC522_Rst(x) gpio_set_value(rc522_RST,(x))
